...
<div>
	...
	<tr>
		<td colspan="2" align="center"><h3> 이름 : <%= ename.elementAt(i) %></h3></td>
	</tr>
	<tr>
		<td>id : <%= idx.elementAt(i) %></td>
		<td>phone : <%= phone.elementAt(i) %></td>
	</tr>
	<tr>
		<td colspan="2">성별 : <%= gender.elementAt(i) %></td>
	</tr>
	<tr>
		<td colspan="2" width="600px">주소 : <%= addr.elementAt(i) %></td>
	</tr>
